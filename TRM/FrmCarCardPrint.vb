...
Public Class FrmCarCardPrint

    Private Sub FrmCarCarPrint_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim Retu As String
        Dim JobName As New ReportParameter("JobName", My.Settings.LocalServer)
        Dim JobPhone As New ReportParameter("JobPhone", My.Settings.CurrentServer)
        Dim JobFax As New ReportParameter("JobFax", My.Settings.AdminUser)
        Dim JobEmail As New ReportParameter("JobEmail", My.Settings.AdminPass)
        Dim JobId As New ReportParameter("JobId", My.Settings.JobId)
        Dim JobAdress As New ReportParameter("JobAdress", My.Settings.OnlineServer)
